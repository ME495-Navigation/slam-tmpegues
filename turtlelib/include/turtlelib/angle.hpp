...
static_assert(
  almost_equal(normalize_angle(std::numbers::pi), std::numbers::pi), "norm_angle failed");
static_assert(
  almost_equal(normalize_angle(-std::numbers::pi), std::numbers::pi), "norm_angle failed");
...
static_assert(
  almost_equal(normalize_angle(-std::numbers::pi), std::numbers::pi), "norm_angle failed");
static_assert(
  almost_equal(normalize_angle(-std::numbers::pi / 4.0), -std::numbers::pi / 4.0),
  "norm_angle failed");
static_assert(
  almost_equal(normalize_angle(3.0 / 2.0 * std::numbers::pi), -std::numbers::pi / 2.0),
  "norm_angle failed");
static_assert(
  almost_equal(normalize_angle(-5.0 * (std::numbers::pi / 2.0)), -std::numbers::pi / 2.0, .01),
  "norm_angle failed");
static_assert(
  almost_equal(normalize_angle(11.0 * std::numbers::pi), std::numbers::pi), "norm_angle failed");
